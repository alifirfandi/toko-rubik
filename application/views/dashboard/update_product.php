...
<head>
    ...
    <title>Toko Rubik - Ubah Produk</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xlg-3 col-md-5">
                    <?= form_open_multipart('admin/update_product', 'class="form-horizontal form-material"') ?>
                    <input type="hidden" value="<?= $product['id'] ?>" name="id">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title"><span class="lstick"></span>Ubah Foto Rubik</h4>
                            <input type="file" name="image" onchange="document.getElementById('image').src = window.URL.createObjectURL(this.files[0])">
                            <center class="m-t-30"> <img src="<?= base_url("assets/img/rubik/") . $product['img'] ?>" class="img-circle" width="150" height="150" id="image" />
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Masukkan Nama Rubik" class="form-control form-control-line" name="name" value="<?= $product['name'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12 InputAddOn">
                                    ...
                                    <input type="text" placeholder="Masukkan Harga" class="uang InputAddOn-field form-control form-control-line" name="price" value="<?= $product['price'] ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Masukkan Stok" class="form-control form-control-line" name="stok" value="<?= $product['stok'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-12">Select Base</label>
                                <div class="col-sm-12">
                                    <select class="form-control form-control-line" name="base">
                                        <option selected disabled>Pilih Base</option>
                                        <?php foreach ($bases as $base) : ?>
                                            <option value="<?= $base['id'] ?>" <?php if($base['id'] == $product['base']) echo "selected" ?>><?= $base['base'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control form-control-line" name="merk">
                                        <option selected disabled>Pilih Merk</option>
                                        <?php foreach ($merks as $merk) : ?>
                                            <option value="<?= $merk['id'] ?>" <?php if($merk['id'] == $product['merk']) echo "selected" ?>><?= $merk['merk'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button class="btn btn-success" type="submit">Update Product</button>&emsp;
                                    <a href="<?= site_url("admin/products") ?>" class="btn btn-secondary"><i class="mdi mdi-close"></i> Cancel</a>
                                </div>
                            </div>
                            <?= form_close() ?>
                        </div>
